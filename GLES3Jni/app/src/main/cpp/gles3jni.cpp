...
extern "C" {
    JNIEXPORT void JNICALL Java_com_ccooy_gles3jni_GLES3JNILib_init(JNIEnv* env, jclass type);
    JNIEXPORT void JNICALL Java_com_ccooy_gles3jni_GLES3JNILib_resize(JNIEnv* env, jclass type, jint width, jint height);
    JNIEXPORT void JNICALL Java_com_ccooy_gles3jni_GLES3JNILib_step(JNIEnv* env, jclass type);
};
...
Java_com_ccooy_gles3jni_GLES3JNILib_init(JNIEnv* env, jclass type) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
...
extern "C" JNIEXPORT void JNICALL
Java_com_ccooy_gles3jni_GLES3JNILib_resize(JNIEnv* env, jclass type, jint width, jint height) {
    if (g_renderer) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_ccooy_gles3jni_GLES3JNILib_step(JNIEnv* env, jclass type) {
    if (g_renderer) {
        g_renderer->render();
    }
}
